  ...
  return (
    <div className="Nav">
      ...
      <div className="navlinks">
        <ul>
          <div className="li-effect">
            <NavLink className={"uscore"} to="/home">Home</NavLink>
          </div>
          <div className="li-effect">
            <NavLink className={"uscore"} to="/Ecell-MU">ESummit'24</NavLink>
          </div>
          <div className="li-effect">
            <NavLink className={"uscore"} to="/esummit">ESummit'23</NavLink>
          </div>
          ...
          {/* <div className="li-effect">
            <NavLink className={"uscore"} to="/speaker">Speakers</NavLink>
          </div> */}
          <div className="li-effect">
            <NavLink className={"uscore"} to="/ourteam">Battalion</NavLink>
          </div>
      ...
      <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <ul>
          <li><NavLink to="/home" onClick={toggleSidebar}>Home</NavLink></li>
          <li><NavLink to="/Ecell-MU" onClick={toggleSidebar}>ESummit'24</NavLink></li>
